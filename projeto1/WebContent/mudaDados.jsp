...
<div class = "panel panel-edfaut">
	<form class = "panel-body" action ="alteraDados" method = "post">
		<%  = (Pessoa)request.getAttribute("pessoaEditada");%>
		<table>
			<tr>
				<td>Nome:</td>
				<td><input type = "text" name = "nome" value = "<%=pessoaEditada.getNome()%>"><br></td></tr>
				<tr>	
				<td>e-mail:</td>
				<td><input type = "text" name = "email" value = "+pegaURL('email')"><br></td>
			</tr>
		</table>
